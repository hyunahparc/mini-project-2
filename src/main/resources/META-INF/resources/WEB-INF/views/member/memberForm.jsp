		...
		<div class="row mb-3">
			...
			<div class="col-auto">
				<button type="button" class="btn btn-primary mb-3"
					id="idDupulicatedcheck">중복 확인</button>
			</div>
			<div class="col-sm-3">
		...
		<div class="row mb-3">
			...
			<div class="col-auto">
				<label for="phone2" class="visually-hidden">전화번호2</label> <input
					type="text" name="phone2" class="form-control" id="phone2"
					path="phone2">
			...
			<div class="col-auto">
				<label for="phone3" class="visually-hidden">전화번호3</label> <input
					type="text" name="phone3" class="form-control" id="phone3"
					path="phone3">
				<form:errors path="phone3"></form:errors>
				<br>
			</div>
		</div>
		<div class="row mb-3">
			...
			<div class="col-auto">
				<input type="text" name="email1" class="form-control" id="email1"
					path="email1">
				<form:errors path="email1"></form:errors>
				<br>
			</div>
			<div class="col-auto">
			...
			<div class="col-auto">
				<label for="email2" class="visually-hidden">이메일2</label> <input
					type="text" name="email2" class="form-control" id="emailText"
					placeholder="직접입력" path="email2">
